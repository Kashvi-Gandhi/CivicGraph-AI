...
// // Preset scenarios for fast hackathon demoing
...
export default function App() {
  return (
    <div style={{ padding: "40px", backgroundColor: "#0f172a", minHeight: "100vh", color: "white" }}>
      <h1 style={{ fontSize: "28px", fontWeight: "bold" }}>CivicGraph AI Loaded Successfully!</h1>
      <p style={{ marginTop: "10px", color: "#94a3b8" }}>
        If you see this text, React and Vite are connected properly.
      </p>
    </div>
  );
}